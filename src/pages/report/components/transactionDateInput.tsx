// TransactionDateInput — identical to DateInput.tsx but with an optional
// displayValue prop that overrides the trigger label (used to show a date
...
interface Props {
  ...
  /** When provided, this string is shown in the trigger instead of the
   *  formatted single date — use it to display a range label. */
  displayValue?: string;
}
...
export default function TransactionDateInput({
  ...
  const triggerLabel =
    displayValue ?? (parsed ? formatDate(parsed, format) : "");
