...
export default function EditProfileDialog({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editForm.role !== (profile.role ?? ""))
        formData.append("role", editForm.role);
      if (editForm.gender !== (profile.gender ?? ""))
        formData.append("gender", editForm.gender);
      if (editForm.dob !== (profile.dob ? profile.dob.split("T")[0] : ""))
        formData.append("dob", editForm.dob);
      if (editForm.storeName !== (profile.storeName ?? ""))
        formData.append("storeName", editForm.storeName);
          ...
          <div className="flex items-center gap-5 mb-4">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-gray-400">
                {editForm.firstName || profile.name}-Profile.png
              </p>
              <input
                ref={fileInputRef}
                type="file"
          ...
          <div className="grid grid-cols-2 gap-5 mb-3">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setEditForm((p) => ({ ...p, storeName: e.target.value }))
                }
              />
            </div>
          </div>
